...
public class PageProperty implements org.apache.thrift.TBase<PageProperty, PageProperty._Fields>, java.io.Serializable, Cloneable, Comparable<PageProperty> {
  ...
  private @org.apache.thrift.annotation.Nullable PageID id; // required
  private @org.apache.thrift.annotation.Nullable PagePropertyValue property; // required
  ...
  public void set_id(@org.apache.thrift.annotation.Nullable PageID id) {
    this.id = id;
  }
  ...
  public void set_property(@org.apache.thrift.annotation.Nullable PagePropertyValue property) {
    this.property = property;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((is_set_property()) ? 131071 : 524287);
    if (is_set_property())
  ...
  public int compareTo(PageProperty other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(is_set_property()).compareTo(other.is_set_property());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_property()) {
