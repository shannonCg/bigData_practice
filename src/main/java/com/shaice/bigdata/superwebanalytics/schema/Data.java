...
public class Data implements org.apache.thrift.TBase<Data, Data._Fields>, java.io.Serializable, Cloneable, Comparable<Data> {
  ...
  private @org.apache.thrift.annotation.Nullable Pedigree pedigree; // required
  private @org.apache.thrift.annotation.Nullable DataUnit dataunit; // required
  ...
  public void set_pedigree(@org.apache.thrift.annotation.Nullable Pedigree pedigree) {
    this.pedigree = pedigree;
  }
  ...
  public void set_dataunit(@org.apache.thrift.annotation.Nullable DataUnit dataunit) {
    this.dataunit = dataunit;
  }
  ...
  public int hashCode() {
    ...
    hashCode = hashCode * 8191 + ((is_set_pedigree()) ? 131071 : 524287);
    if (is_set_pedigree())
      hashCode = hashCode * 8191 + pedigree.hashCode();

    hashCode = hashCode * 8191 + ((is_set_dataunit()) ? 131071 : 524287);
    if (is_set_dataunit())
  ...
  public int compareTo(Data other) {
    ...
    lastComparison = java.lang.Boolean.valueOf(is_set_pedigree()).compareTo(other.is_set_pedigree());
    if (lastComparison != 0) {
    ...
    lastComparison = java.lang.Boolean.valueOf(is_set_dataunit()).compareTo(other.is_set_dataunit());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (is_set_dataunit()) {
